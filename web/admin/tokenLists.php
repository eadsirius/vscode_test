                            ...
                            <div class="card-body">
    							...
    							?>
                                    <tr>
										...
										<td><?=$row->regdate?></td>
										<td>
	                                        <a href="/admin/point/write/<?=$row->coin_no?>" class="btn btn-secondary footable-edit">
		                                        <span class="fas fa-pencil-alt" aria-hidden="true"></span></a>
											<a href="/admin/point/delete/<?=$row->coin_no?>" class="btn btn-secondary footable-delete">
