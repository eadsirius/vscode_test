          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12 col-md-6">
                ...
                <h6 class="card-subtitle">삭제 매출을 파악하실 수 있습니다.</h6>
              ...
              <div class="col-sm-12 col-md-6">
                <div class="dataTables_length">
                  <form name='fsearch' method='post' action="<?=SEARCH_URL?>">
                    ...
                    <button type="button" class="btn1 btn-primary" style="height: 28px;background:#2962FF;border-color:#2962FF" onclick="location.href='/admin/point/del_lists'">초기화</button>
                    <button type="button" class="btn1 btn-primary" style="height: 28px;"><a href="/admin/excel/purchase" style="color: #ffffff;">Excel</a></button>
                  </form>
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
            ...
            <table id="mainTable" class="table editable-table table-bordered table-striped m-b-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td><?=@$row->type?></td> -->
                  <td class="txt_right"><?=number_format($row->point)?></td>
                  <td class="txt_right"><?=number_format($row->saved_point)?></td>
                  <td class="txt_center"><?=date("Y-m-d H:i:s",strtotime($row->regdate." +9 hours"))?></td>

                  <td class="txt_center"><?=date("Y-m-d H:i:s",strtotime($row->deldate." +9 hours"))?></td>
