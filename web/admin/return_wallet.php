...
-->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?=$title?> | 반품리스트  <?=$total_count?>명</h4>
                                <h6 class="card-subtitle">UCE Token 반품 리스트</h6>
    							...
    							?>
                                    ...
                                    <tr>
										...
										<td><?=$row->point > 0  ? number_format($row->usns ) : 0;?></td>
										<td><?=$row->point > 0  ? number_format($row->usns * ($row->fee /100) ): 0;?></td>
										<td><?=$row->tx_id?></td>
										<td><?=$row->wdate?></td>
