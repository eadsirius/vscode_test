				                    ...
				                    <div class="col-sm-12 col-md-6">
					                    <div class="dataTables_filter">
			                                ...
			                                <select name="list" class="form-control form-control-sm" onchange="location.href=this.value">
				                                ...
				                                <option value="/admin/config/page/10/planlist" <?if($list_per == 10){?>selected<?}?>>10</option>
				                                <option value="/admin/config/page/25/planlist" <?if($list_per == 25){?>selected<?}?>>25</option>
				                                <option value="/admin/config/page/50/planlist" <?if($list_per == 50){?>selected<?}?>>50</option>
				                                <option value="/admin/config/page/100/planlist" <?if($list_per == 100){?>selected<?}?>>100</option>
				                            </select>
						                </div>
						            </div>
						        </div>
