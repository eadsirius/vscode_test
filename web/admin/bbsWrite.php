...
-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title"><?=$title?> 수정하기</h4>
						<!-- Tab panes -->
						<div class="tab-content tabcontent-border">
							<div class="p-20">
								<form name="writeForm" id="writeForm" action="/admin/bbs/writer" method="post"
									...
									<div class="form-group">
										<div class="form-group10 row">
											...
											<div class="col-9">
												<select name="category" id="category" class="form-control input-lg" required itemname="구분">
													<option value='공지사항' <?if($item->category == '공지사항'){?>selected
														<?}?> >공지사항</option>
													<!-- <option value='뉴스' <?if($item->category == '뉴스'){?>selected
														<?}?>>뉴스</option> -->
												</select>
											</div>
										</div>
										...
										<div class="form-group10 row">
											...
											<div class="col-9">
												<textarea name="contents" rows="10"><?=@$item->contents?></textarea>
												<script>
										...
										<div class="form-group10 row">
											...
											<div class="col-9">
												<input type="file" class="form-control" name="upfile" id="upfile" value="" itemname="file">
												<?=$item->file?>
												<img src="/data/uploads/<?=$item->file?>">
											</div>
										</div>
										...
										<div class="form-group10 row">
											...
											<div class="col-9">
												<input type="text" class="form-control" name="regdate" value="<?=$item->regdate?>" required>
											</div>
										</div>
