...
-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">매출승인 수정하기</h4>
                                <!-- Tab panes -->
                                <div class="tab-content tabcontent-border">
                                    <div class="p-20">
										<form name="reg_form" action="/admin/point/pointRev_edit" method="post" onsubmit="return formCheck();">
                                        ...
                                        * 매출신청을 승인하기는 리스트에서 해주시길 바랍니다.<br>
