                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5><?=get_msg($select_lang, '거래소 WNS 주소 등록 정보')?></h5>
                        </div>
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form id="reg_form" name="reg_form" action="<?=current_url()?>" class="form-horizontal" method="post" onsubmit="return formCheck(this);">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label"><?=get_msg($select_lang, '거래소 WNS지갑 주소')?></label>
                                            <div class="col-sm-10"><input type="text" class="form-control" name="address" id="address" maxlength="42" required /></div>
                                        </div>

                                        <button id='btn_submit' type="button" class="btn btn-lg btn-block btn-primary m-t-md"><?=get_msg($select_lang, '등록')?></button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
function formCheck(frm) 
{
    if (frm.address.value == "") {
        alert("비트코인 지갑 주소를 입력하세요");
        frm.rev_id.focus();
        return false;
    }
    return true;
}
<?if($site->cfg_phone_bit == 1){?>
