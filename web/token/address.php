...
?>
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-12">
                <h2><?=get_msg($select_lang, '전자지갑 주소')?></h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">
                        <strong><?=get_msg($select_lang, 'WNS 주소')?></strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5><?=get_msg($select_lang, 'WNS 정보')?></h5>
                        </div>
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                ...
                                <hr class="hr-line-dashed" style="margin:10px 0" />
                                <div class="form-group">
                                    <label class="col-lg-2 control-label"><?=get_msg($select_lang, 'WNS 잔액')?> :</label>
                                    <div class="col-lg-10"><p class="form-control-static"><?=number_format($bal->token,2)?>WNS</p></div>
                                </div>
