...
<div class="app-content">
	<div class="side-app">
		...
		<div class="card">
			<div class="card-header">
				<h3 class="mb-0 card-title">Security Settings</h3><br>
			</div>
			<div class="card-body">				
				<div class="col-sm-12 col-lg-12">
					...
					<!--<a href="/member/profile/passwordEx"><button class="btn btn-default "><i class="fa fa-key"></i> Transfer password</button></a>-->
