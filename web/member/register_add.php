...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2><?=get_msg($select_lang, '직추천 가입')?></h2>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">
                <strong><?=get_msg($select_lang, '직추천 가입')?></strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
            ...
            <div class="ibox float-e-margins">
				...
				<form name="reg_form" class="form-horizontal" action="<?=current_url()?>" method="post" onsubmit="return formCheck();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9"><input type="text" class="form-control" name="recommend_id" id='recommend_id' value="<?=$mb->member_id?>" onblur='recheck();' required readonly /></div>
						<div class="reg-error pull-right m-r-md"  id='msg_re_id' class="msg"></div>
                    </div>
                    <div class="hr-line-dashed" style="margin:10px 0"></div>
                    <!--
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=get_msg($select_lang, '후원인 ID')?> :</label>
                        <div class="col-lg-9"><input type="text" class="form-control" name="sponsor_id" id='sponsor_id' value="" onblur='spcheck();' required /></div>
        ...
        <div class="col-lg-6">
            <img src="/assets/img/bg/img_sponsor.png" width="100%" height="auto" alt="" />
        </div>
    </div>
</div>
