		...
		<table class="table table-bordered" style="margin: 40px auto; width:100%; color: black;">
			...
			<tbody>
				<tr>
					...
					<td class="tx_right"><?=number_format($row->basic_day)?></td>
					...
					<td class="tx_right"><?=number_format($row->basic_mc)?></td>
					<td class="tx_right"><?=number_format($row->basic_mc2)?></td>
					<td class="tx_right"><?=number_format($row->basic_re)?></td>
					<td class="tx_right"><?=number_format($row->basic_re2)?></td>
				...
				<tr>
					<td colspan="18">
						<ul class="pagination" style="margin-top:10px">
							<?php 
							if((!empty($list))) {
								paging("/member/Checktest",$total_count,$page,$size,"");
							}?>
						</ul>
					</td>
				</tr>
